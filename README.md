# Prometheus service for Wodby

Use Prometheus as a reusable component in applications managed by Wodby. This
repository contains the service manifests and referenced files used by the
public Prometheus service in the Wodby catalog.
...
4. Reference `prometheus` from your stack manifest.
